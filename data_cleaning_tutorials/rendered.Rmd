...
- [`hist`](https://www.rdocumentation.org/packages/graphics/versions/3.4.3/topics/hist)
- [`read.csv`](https://www.rdocumentation.org/packages/utils/versions/3.4.3/topics/read.table)
- [`row.names`](https://www.rdocumentation.org/packages/base/versions/3.4.3/topics/row.names)
- [`head`](https://www.rdocumentation.org/packages/utils/versions/3.4.3/topics/head)
- [`nrow`](https://www.rdocumentation.org/packages/base/versions/3.4.3/topics/nrow)
- [`ncol`](https://www.rdocumentation.org/packages/base/versions/3.4.3/topics/nrow)
